...
> Restaurante de bocatos romanos artesanales en Murcia, España. Street food italiano con masa fermentada mínimo 72 horas.
...
## Lo que somos
Bocato di Roma es un local de street food italiano en el centro de Murcia. Nuestro producto estrella es el bocato romano: un pan redondo de masa fermentada mínimo 72 horas, horneado al momento, relleno con ingredientes italianos de denominación de origen protegida (DOP) e indicación geográfica protegida (IGP).
